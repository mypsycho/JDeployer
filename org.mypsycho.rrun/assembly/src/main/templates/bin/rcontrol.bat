...
goto run
:gotJavaHome
set JAVA_EXEC="%JAVA_HOME%\bin\javaw"
goto run

:run
%JAVA_EXEC% %${project.scriptName}_OPTS% -jar "%${project.scriptName}_HOME%\${project.build.jar-path}\${project.groupId}\${project.build.finalName.control}.jar" %*
