...
public class ControlPane extends JSplitPane implements ControlListener {
    ...
    protected JTabbedPane cmdTabs = new JTabbedPane();
    protected JTextArea stdOutput = new JTextArea();
    protected JTextArea errOutput = new JTextArea();
    ...
    public ControlPane(Controller pCore) {
        ...
        // Refresh outputs on 
        cmdTabs.addChangeListener(new ChangeListener() {
            @Override
    ...
    public void refreshOutput() {
        ...
        if (command != null) {
            JTextArea text = stdOutput.isShowing() 
                    ? stdOutput : errOutput.isShowing() ? errOutput : null;
            if (text != null) {
                try {
