...
public class Processor implements ProcessRmi {
    ...
    protected TraceProvider traceProvider = null;
    ...
    public String getExecutorText(Command exe, boolean std) throws RemoteException {
        return (traceProvider != null) ? traceProvider.getExecutorText(exe, std) : "";
    }
    ...
    /**
     * Returns the traceProvider.
     *
     * @return the traceProvider
     */
    ...
    /**
     * Sets the traceProvider.
     *
     * @param traceProvider the traceProvider to set
     */
    ...
    /* (non-Javadoc)
     * @see com.psycho.deploy.ProcessRmi#getTraces(com.psycho.deploy.Command, boolean)
     */
    @Override
    public String getTraces(Command cmd, boolean std) throws RemoteException {
        return traceProvider.getExecutorText(cmd, std);
    }
