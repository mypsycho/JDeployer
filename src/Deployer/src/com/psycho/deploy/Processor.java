...
public class Processor implements ProcessRmi {
    ...
    void firePropertyChange(Executor exe, String prop) {
        listeners.firePropertyChange(prop, null, exe);
    }
...
//    protected ProcessPane displayed = null;
//    public synchronized void display() {
//        if (displayed == null) {
//            // Local configuration must be set prior any display
//            Language.getLanguage();
//            displayed = new ProcessPane(this);
//            displayed.display();
//        }
//    }
//    void setDisplayed(ProcessPane pane) {
//        displayed = pane;
//    }
//    public boolean isDisplayed() { return displayed != null; }
//
//
//
//    // --- Main --------------------------------------
...
//        } catch (Throwable t) {
//            WorkshopFactory.getWorkshop().showError(t);
//            System.exit(1);
//        }
//    }
