...
public class ControlApplication extends CommonApplication {
    ...
    public class AppFrame extends PagedFrame {
        ...
        @Action(enabledProperty="enableds(popupError)")
        ...
        public void updateStatus(Object status) {
            ...
            if (status instanceof Throwable) {
                msg = ((Throwable) status).getMessage();
            } else if (status != null) {
            ...
            if ((status instanceof Throwable) && getEnableds("popupError")) {
                JOptionPane.showMessageDialog(pane, msg,
                        getProperty("view(errorDialog).title"), JOptionPane.ERROR_MESSAGE);
...
//        }
    ...
    public static void main(String[] args) {
        ...
        new ControlApplication().launch(args);
    }
